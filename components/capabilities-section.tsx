      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="mx-auto inline-flex w-fit flex-col items-center">
            <h2 className="inline-block text-center text-4xl md:text-5xl font-bold text-[#1a1a1a] dark:text-white">
              {t("capabilitiesTitle")}
            </h2>
            <div className="relative mt-3 h-1 w-full mb-6 scale-x-60 sm:scale-x-100">
              <div
